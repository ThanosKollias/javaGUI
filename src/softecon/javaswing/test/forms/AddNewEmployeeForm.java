...
//                JOptionPane.showMessageDialog(null, e.getMessage(), "END OF FILE", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        empSurnameLbl = new javax.swing.JLabel();
        ...
        empIdLbl.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 12)); // NOI18N
        empIdLbl.setText("Employee ID :");

        empNameLbl.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 12)); // NOI18N
        empNameLbl.setText("Employee Name :");

        empSurnameLbl.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 12)); // NOI18N
        empSurnameLbl.setText("Employee Surname :");

        empJobLbl.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 12)); // NOI18N
        empJobLbl.setText("Choose Job :");
...
//            VO_Employee emp = new VO_Employee(id, name, surname, finalJob);
        VO_Employee emp = new VO_Employee(name, surname, finalJob);

        if (empList.contains(emp)) {
            JOptionPane.showMessageDialog(null, "Employee alrdy exists");
        } else {
            empList.add(emp);
            saveEmpToFile();
...
//            saveEmpToFile();
    ...
    private javax.swing.JLabel empSurnameLbl;
